...
public class tambah extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            rs = st.executeQuery("select * from tbl_barang where kd_barang='"+kd+"'");
            if (rs.next()) {
                int stok  = Integer.parseInt(jTextField1.getText())+Integer.parseInt(rs.getString("stok"));
                st = con.createStatement();
                st.executeUpdate("update tbl_barang set stok = '"+stok+"' where kd_barang='"+kd+"'");
